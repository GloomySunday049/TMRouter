#
#  Be sure to run `pod spec lint TMRouter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "TMRouter"
  s.version      = "0.0.1"
  s.summary      = "A short description of TMRouter."
  ...
  # Or just: s.author    = "GloomySunday"
  # s.authors            = { "GloomySunday" => "121055230@qq.com" }
